...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220211_marcusacademy_cab12f0dff18aab07778_20220328143359_archive.zip';
	const ARCHIVE_SIZE		 = '148265478';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'cab12f0-28143359';
    const SECONDARY_PACKAGE_HASH = '64df1dd-28143359';
	const VERSION			 = '1.4.3';
